...
document.addEventListener('DOMContentLoaded', (event) => {
  document.getElementById('bossSignupForm').addEventListener('submit', function(event) {
    var id = document.getElementById('id').value;
...
<body>
	...
	<form id="bossSignupForm" method="post">
		<div class="container">
			<div class="row">
				<div class="col-sm-3"></div>
				<div class="col-sm-6">
					<h1 class="text-center mt-4 ml-4">사업자 회원가입</h1>
					<div class="row m-3 btn-block">
						...
						<div class="form-group">
							<b class="float-left">사업자 등록증</b> <input type="text"
								class="form-control" id="businessNo" name="businessNo"
								placeholder="사업자 등록증을 입력해주세요.">
						</div>
						<button class="btn btn-lg btn-primary btn-block">가입완료</button>
					</div>
				</div>
			</div>
		</div>
