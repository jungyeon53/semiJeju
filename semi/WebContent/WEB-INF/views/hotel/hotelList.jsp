            ...
            <div class="list-hotels">
       		<c:forEach items="${hotels}" var="hotel">
			    <div class="card bg-secondary text-white mb-1" data-avg="${hotel.avg}" data-price="${hotel.price}">
			        <a href="/hotel/room?ano=${hotel.ano}&hno=${hotel.hno}&in=${in}&out=${out}" style="background: url('${pageContext.request.contextPath}/display?path=${hotel.ano}/${hotel.hno}&uuid=0.jpg') no-repeat center; background-size:cover;">
